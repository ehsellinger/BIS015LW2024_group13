...
2. Load the Data
```{r}
conservatory <- read_csv("BIS015LW2024_group13/Elisabeth/conservatory_data.csv") %>% clean_names()
```
3. Clean the Data
```{r}
...
```{r}
plants <- read_csv("BIS015LW2024_group13/Elyse/Biodiversity_Data.csv") %>% clean_names() %>% 
